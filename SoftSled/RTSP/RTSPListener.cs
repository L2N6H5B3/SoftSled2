                    ...
                    if (currentMessage != null)
                    {
                        ...
                        if (currentMessage is RtspResponse)
                        {
                            ...
                            lock (_sentMessage)
                            {
                                ...
                                {
                                    System.Diagnostics.Debug.WriteLine($"Receive response not asked {response.CSeq}");
                                }
                            }
...
//                throw;
        ...
        public bool SendMessage(RtspMessage message)
        {
            ...
            if (!_transport.Connected)
            {
                ...
                System.Diagnostics.Debug.WriteLine("Reconnect to a client, strange !!");
                try
                {
                    Reconnect();
                }
                ...
                switch (currentReadingState)
                {
                    ...
                    case ReadingState.Data:
                        if (currentMessage.Data.Length > 0)
                        {
                            ...
                            System.Diagnostics.Debug.WriteLine($"Readen {byteReaden} byte of data");
                        }
        ...
        public void EndSendData(IAsyncResult result)
        {
            ...
            } catch (Exception e)
            {
                ...
                System.Diagnostics.Debug.WriteLine("Error during end send (can be ignored) " + e);
                result = null;
            }
        }
