...
namespace SoftSled.Components.AudioVisual {
    ...
    public class WmrptAudioDepacketizer {
        ...
        public void ProcessWmrptPayload(byte[] rtpPayload, int rtpPayloadLength, uint rtpSsrc, ushort rtpSequenceNumber, uint rtpTimestamp) // Kept ushort for sequence number
        {
