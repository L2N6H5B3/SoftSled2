...
//        // Extracted the original synchronous logic into a private helper method
//        private void ProcessWmrptPayloadInternal(byte[] rtpPayload, int rtpPayloadLength, uint rtpSsrc, ushort rtpSequenceNumber, uint rtpTimestamp) {
