		...
		public bool IsValid(Rtsp.Messages.RtspMessage received_message) {
            ...
            if (authentication_type == Type.Basic && authorization.StartsWith("Basic ")) {
                ...
                if ((decoded_username == username) && (decoded_password == password)) {
					System.Diagnostics.Debug.WriteLine("Basic Authorization passed");
                    return true;
                } else {
					System.Diagnostics.Debug.WriteLine("Basic Authorization failed");
                    return false;
                }
            }
            ...
            if (authentication_type == Type.Digest && authorization.StartsWith("Digest ")) {
				...
				if ((auth_header_username == this.username)
				    ...
				    System.Diagnostics.Debug.WriteLine("Digest Authorization passed");
                    return true;
                } else {
					System.Diagnostics.Debug.WriteLine("Digest Authorization failed");
                    return false;
                }
            }
            return false;
