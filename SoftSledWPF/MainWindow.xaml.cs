...
namespace SoftSledWPF {
    ...
    public partial class MainWindow : Window {
        ...
        // MainWindow_Loaded so we can hand it the WPF dispatcher and the
        ...
        // FFME → IMediaController adapter. Owned by MainWindow; lifetime
        ...
        private void MainWindow_Loaded(object sender, RoutedEventArgs e) {
            ...
            // tree (declared in MainWindow.xaml above rdpDisplay); the
        ...
        private void McxSessHandler_StatusChanged(object sender, StatusChangedArgs e) {
            Dispatcher.BeginInvoke(new Action(() => {
                if (e.shellOpen && m_capabilities.GetRenderMode() == SoftSled.Components.Extender.WMCRenderMode.GDI) {
        ...
        private void BtnConnect_Click(object sender, RoutedEventArgs e) {
            ...
            freeRdpClient.SetInitialDesktopSize(1280, 720);
